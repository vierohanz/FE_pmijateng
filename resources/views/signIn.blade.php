...
<body class="overflow-x-hidden  bg-white">
    ...
    <div class=" w-full bg-[#EFEFEF] py-10 px-5 xl:py-24 xl:px-56">
        <div class="h-full w-full grid grid-cols-1 xl:grid-cols-5 bg-red-600 rounded-badge shadow-2xl">
            <div
                class="h-full hidden xl:flex col-span-2 rounded-l-badge p-7 bg-red-600 flex-col items-center justify-cente">
                <div class="w-full ">
                    <a href="{{ route('index') }}"
                        class=" font-poppins text-white text-lg hover:text-xl transition-all duration-300 font-semibold">Back</a>
                </div>
                <div
                    class="h-full hidden xl:flex col-span-2 rounded-l-badge p-9 bg-red-600 flex-col items-center justify-center">
            ...
            <div
                ...
                <div class="row-span-1 w-full h-full flex space-x-2 items-center justify-end">
                    <div class="flex-col justify-end items-end text-end">
                        <p class="font-poppins font-bold text-red-600 text-xl">PUSDIKLAT</p>
                        <p class="font-poppins font-normal text-custom-secondary text-sm">Provinsi Jawa Tengah</p>
                    </div>
                    <div class="h-full w-2 bg-red-600"></div>
                    <div class="flex">
                    ...
                    <form action="{{ route('signIn') }}" method="POST"
                        ...
                        <div class="mt-9 w-full xl:w-97">
                            <div class="">
                                ...
                                <input type="text" name="email"
                                    class="autofill:border-none autofill:bg-none w-full px-4 text-lg text-black font-poppins font-normal rounded-2xl h-14 bg-gray-100 border-2 border-transparent focus:border-[#E02424] focus:outline-none focus:ring-0 focus:ring-offset-0">
                                @if ($errors->has('email'))
                                    <p class="text-red-600 text-sm mt-1">{{ $errors->first('email') }}</p>
                                @elseif($errors->has('credentials'))
                                    <p class="text-red-600 text-sm  mt-1">{{ $errors->first('credentials') }}
                                    </p>
                                @endif
                            </div>
                            <div class="mt-4">
                        ...
                        <div class="flex flex-row  justify-between mt-4 w-full">
                            <label class="relative inline-flex items-center cursor-pointer select-none">
                                ...
                                <div
                                    class="w-5 h-5 bg-white border-2 rounded-md  border-[#E02424] peer peer-checked:border-0 peer-checked:bg-[#E02424]">
                            ...
                            <a href="{{ route('forgetPassword') }}"
                                class="mt-2 sm:mt-0 text-base font-medium text-[#E02424] hover:scale-110 transition-all duration-300">Lupa
                                password?</a>
                        </div>
