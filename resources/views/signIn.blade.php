...
<body class="overflow-x-hidden  bg-white">
    ...
    <div class=" w-full bg-[#EFEFEF] py-10 px-5 xl:py-24 xl:px-56">
        <div class="h-full w-full grid grid-cols-1 xl:grid-cols-5 bg-[#F05252] rounded-badge shadow-2xl">
            <div
                class="h-full hidden xl:flex col-span-2 rounded-l-badge p-7 bg-[#F05252] flex-col items-center justify-cente">
                <div class="w-full ">
                    <a href="{{ route('index') }}"
                        class=" font-poppins text-white text-lg hover:text-xl transition-all duration-300 font-semibold">Back</a>
                </div>
                <div
                    class="h-full hidden xl:flex col-span-2 rounded-l-badge p-9 bg-[#F05252] flex-col items-center justify-center">
            ...
            <div
                ...
                <div class="row-span-1 w-full h-full flex space-x-2 items-center justify-end">
                    <div class="flex-col justify-end items-end text-end">
                        <p class="font-poppins font-bold text-red-500 text-xl">PUSDIKLAT</p>
                    ...
                    <form action="{{ route('signIn') }}" method="POST"
                        ...
                        <div class="mt-9 w-full xl:w-97">
                            <div class="">
                                ...
                                <input type="text" name="email"
                                    class="autofill:border-none autofill:bg-none w-full px-4 text-lg text-black font-poppins font-normal rounded-2xl h-14 bg-gray-100 border-2 border-transparent focus:border-[#F05252] focus:outline-none focus:ring-0 focus:ring-offset-0">
                                @if ($errors->has('email'))
                            ...
                            <div class="mt-4">
                                ...
                                <input type="password" name="password"
                                    class="w-full px-4 text-lg text-black font-poppins font-normal rounded-2xl h-14 bg-gray-100 border-2 border-transparent focus:border-[#F05252] focus:outline-none focus:ring-0 focus:ring-offset-0">
                        ...
                        <div class="flex flex-row  justify-between mt-4 w-full">
                            <label class="relative inline-flex items-center cursor-pointer select-none">
                                ...
                                <div
                                    class="w-5 h-5 bg-white border-2 rounded-md  border-[#F05252] peer peer-checked:border-0 peer-checked:bg-[#F05252]">
                            ...
                            <a href="{{ route('forgetPassword') }}"
                                class="mt-2 sm:mt-0 text-base font-medium text-[#F05252] hover:scale-110 transition-all duration-300">Lupa
                                password?</a>
                        </div>
                        <div class="mt-4 w-full">
                            <img src="{{ captcha_src() }}" alt="captcha" class="w-full">
                            <input type="text" name="captcha"
                                class="form-control focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-[#F05252] text-black font-poppins w-full @error('captcha') is-invalid @enderror"
