...
>>>>>>> ed78faf556f8c3f3270a976c4a2cbed4331f91ab
        ...
        <form id="booking-package-form">
            ...
            <div class="px-4 md:px-16 lg:px-32 xl:px-48 py-10 bg-white w-full h-full">
                <div class="bg-gray-100 w-full h-full rounded-badge px-6 md:px-8 lg:px-10 py-10 flex-col flex space-y-8">
                    ...
                    <div>
                        <p for="tanggal-masuk-package" class="font-poppins font-semibold text-black text-base md:text-lg">Tanggal masuk
                        </p>
                    ...
                    <div>
                        <p for="tanggal-keluar-package" class="font-poppins font-semibold text-black text-base md:text-lg">Tanggal
                            keluar</p>
