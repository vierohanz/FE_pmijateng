    ...
    <div class="w-full h-auto pt-9 xl:pt-12 bg-white">
            ...
            <form id="booking-form">
                ...
                <div class="px-4 md:px-16 lg:px-32 xl:px-48 py-10 bg-white w-full h-full">
                    <div class="bg-gray-100 w-full h-full rounded-badge px-6 md:px-8 lg:px-10 py-10 flex-col flex space-y-8">
                        ...
                        <div>
                            <p for="tanggal-masuk" class="font-poppins font-semibold text-black text-base md:text-lg">
                                Tanggal masuk
                            </p>
                        ...
                        <div>
                            <p for="tanggal-keluar" class="font-poppins font-semibold text-black text-base md:text-lg">
                                Tanggal
                                keluar</p>
        ...
        @else
            <form id="booking-package-form">
                ...
                <div class="px-4 md:px-16 lg:px-32 xl:px-48 py-10 bg-white w-full h-full">
                    <div
                        class="bg-gray-100 w-full h-full rounded-badge px-6 md:px-8 lg:px-10 py-10 flex-col flex space-y-8">
                        <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            @foreach ($room as $item)
                                <div class="text-start flex-col justify-start space-y-2 items-center">
                                    <p class="font-poppins text-base md:text-lg font-semibold text-black">Harga kamar</p>
                                    <p class="font-poppins text-sm font-normal text-black">*(1x) {{ $item['name'] }} (1
                                        malam)</p>
                                    <input type="hidden" name="package_id" value="{{ $item['id'] }}">
                                </div>
                                <div class="flex justify-end text-end items-center">
                                    <input id ="price_per_person" type="hidden"
                                        value="{{ $item['price_per_person'] ?? 0 }}" readonly>
                                    <p class="font-poppins text-lg md:text-xl font-bold text-black">Rp
                                        {{ $item['price_per_person'] ?? 0 }}</p>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="flex justify-end text-end items-center">
                                <p id="total-price-package" class="font-poppins text-lg md:text-xl font-bold text-black">
                                    Rp </p>
                            </div>
                        </div>
                        ...
                        <div class="w-full flex justify-center items-center">
                            <button type="submit"
                                class="w-3/4 hover:scale-105 transition-all duration-300 h-14 md:h-16 flex justify-center items-center mt-6 rounded-2xl bg-red-700 text-lg md:text-xl font-poppins text-white font-semibold">Lanjutkan</button>
                        </div>
                    </div>
                </div>
                <input type="hidden" value="{{ session('user')['email'] }}" readonly name="user_email">
