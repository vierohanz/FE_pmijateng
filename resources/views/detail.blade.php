        ...
        <div class="w-full bg-white">
                ...
                <div class="relative h-full w-full overflow-hidden rounded-b-badge shadow-lg">
                    ...
                    @foreach ($room['room_images'] as $index => $image)
                        <div class="{{ $loop->first ? 'block' : 'hidden' }} duration-700 ease-in-out" data-carousel-item>
                            <img src="{{ $image }}" alt="Image Meeting Room"
                ...
                <div id="bounceMeeting" class="carousel carousel-center bg-white rounded-box w-full space-x-7">
                    @foreach ($room['room_images'] as $index => $image)
                        <div class="carousel-item w-108 h-64 xl:h-96">
                            <img src="{{ $image }}" alt="Image Meeting Room {{ $index + 1 }}"
            ...
            <div class="h-44 px-6 xl:px-12 w-full  grid grid-cols-2">
                <div class="col-span-1 gap-2 flex-col flex items-start justify-start">
                    <p class="font-josefinSans font-bold text-xl xl:text-5xl text-black">
                        {{ $room['room_data']['room_type'] }}</p>
                    <div class="flex">
                ...
                <div class="col-span-1 flex-col flex justify-start items-end gap-4">
                    ...
                    <div
                        class="w-40 xl:w-72 h-10 xl:h-20 rounded-full border-2 items-center justify-center flex border-red-600 ">
                        ...
                        <p class="ml-2 font-poppins text-red-600 text-base xl:text-2xl font-semibold">Rp
                            {{ (int) $room['room_data']['price'] }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-20 w-full px-6 xl:px-12 flex-col flex ">
                <div class="flex justify-start items-start">
                    <p class="font-josefinSans text-red-600 font-bold text-2xl xl:text-4xl">Fasilitas</p>
                </div>
                <div class="grid grid-cols-3 mt-12">
                    <div class="col-span-1 flex gap-3 flex-col items-center justify-center">
                        ...
                        <p class="font-poppins text-xl text-custom-secondary font-semibold">
                            {{ $room['room_data']['capacity'] }} Tamu </p>
                    </div>
            ...
            <div class="h-48 flex flex-col w-full mt-16 px-28">
                ...
                <div class="w-full flex items-center justify-between mt-5">
                    <a href="{{ route('index') }}"
                        class="h-16 items-center justify-center text-xl hover:scale-110 duration-300 transition-all font-poppins font-semibold text-white flex w-72 bg-red-600 rounded-2xl">
                        Back
                    </a>
