...
@section('content')
        ...
        <form action="{{ url('/availableRooms') }}" class="col-span-4 grid grid-cols-4 gap-5 items-center space-x-9"
            ...
            <div class="col-span-4 grid grid-cols-4 gap-5 items-center space-x-9">
                <div class="text-white text-start">
                    <label for="arrival-date" class="block text-lg font-poppins font-semibold">Tanggal datang</label>
                ...
                <div class="text-white text-start">
                    <label for="departure-date" class="block text-lg font-poppins font-semibold">Tanggal pergi</label>
                    <div class="flex items-center border-b-2 border-white">
                ...
                <div class="text-white text-start">
                    <label for="guests" class="block text-lg font-poppins font-semibold">Jumlah tamu</label>
                    <div class="flex items-center border-b-2 border-white">
        ...
        <div class="w-full h-full mx-auto bg-gray-100 shadow-xl rounded-lg p-4 md:p-6">
            ...
            <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500"
                ...
                @if (isset($availableRooms) && count($availableRooms) > 0)
                    ...
                    @endforeach
                @else
                    <p class="justify-center items-center flex mt-5 font-poppins font-medium text-lg">Tidak ada ruang
                        tersedia.</p>
                @endif
            </div>
        </div>
            ...
            <div class="w-full h-full ml-2 xl:ml-5 my-2 xl:my-5">
                ...
                <div data-aos="fade-down" id="carousel"
                    ...
                    <div class="carousel-item"
                        data-description="Ini adalah kamar mewah kami dengan tempat tidur ukuran king dan fasilitas modern. Tata letak yang luas dihiasi dengan perabotan elegan yang menciptakan suasana yang hangat dan mengundang.">
                    ...
                    <div class="carousel-item" class="font-poppins font-base text-5xl"
                        data-description="Kamar kami dilengkapi dengan kamar mandi yang menakjubkan, dilengkapi dengan semua kebutuhan yang Anda butuhkan. Kamar mandi memiliki tata letak yang luas dengan meja marmer elegan dan perlengkapan modern yang menciptakan suasana yang mewah.">
                        <img class="rounded-box h-52 xl:h-97 bg-corousel_2 bg-center bg-cover w-80 xl:w-104" />
                    </div>
                    <div class="carousel-item"
                        data-description="Kamar kami dilengkapi dengan kamar mandi yang menakjubkan, dilengkapi dengan semua kebutuhan yang Anda butuhkan. Tata letak yang luas memungkinkan pergerakan yang nyaman, sementara desain yang elegan menggabungkan perlengkapan modern dan sentuhan mewah.">
                        <img class="rounded-box h-52 xl:h-97 bg-corousel_3 bg-center bg-cover w-80 xl:w-104" />
                    </div>
                    <div class="carousel-item"
                        data-description="Kamar yang elegan dengan suasana tenang untuk relaksasi Anda. Warna-warna lembut dan redup menciptakan atmosfer yang menenangkan, mengundang Anda untuk bersantai setelah seharian beraktivitas.">
            ...
            <div class="flex space-x-8 snap-x snap-mandatory mt-3">
                @forelse ($packageRooms as $packageRoom)
                    <a href="{{ route('package.details', ['id' => $packageRoom['id']]) }}"
                        class="hover:scale-105 duration-150 transition-all ml-3 ml-9">
                        <div
    ...
    <div id="services" class="h-120 md:h-80 xl:h-101 mt-14 w-full">
        ...
        <div class="h-116 w-full mt-10 grid grid-rows-4 md:grid-cols-4 gap-4 p-10 justify-items-center">
            <div
                class="shadow-lg bg-[#D9D9D9] rounded-3xl hover:bg-custom-primary text-red-500 fill-custom-primary hover:fill-custom-third hover:text-custom-third transition-all duration-300 aspect-square h-60 md:h-40 xl:h-80 flex-col gap-3 flex justify-center items-center">
            ...
            <div
                ...
                <p class="font-judson font-semibold text-xl xl:text-3xl">Spa Indah</p>
            </div>
        </div>
    </div>
