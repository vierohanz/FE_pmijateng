...
{{-- our services --}}
    <div id="services" class="h-124 xl:h-101 mt-10 w-full">
        ...
        <div class="h-116 w-full mt-10 grid grid-rows-4 xl:grid-cols-4 gap-4 p-10 justify-items-center">
            <div class="shadow-lg bg-[#D9D9D9] rounded-3xl hover:bg-custom-primary text-custom-primary fill-custom-primary hover:fill-custom-third hover:text-custom-third transition-all duration-300 aspect-square h-60 xl:h-80 flex-col gap-3 flex justify-center items-center">
...
{{-- Our Gallery --}}
    <div class="h-124 xl:h-110 mt-10 w-full">
        ...
        <div class="grid mt-10 h-108 grid-cols-3 gap-5 p-5">
...
{{-- About us --}}
    <div id="about_us" class="h-108 w-full  mt-16">
        <div class="h-10 w-full  ml-7">
            <p class="font-freehand text-custom-primary font-bold text-5xl">About Us</p>
        </div>
        <div class="grid grid-cols-12 h-full gap-7 p-5 mt-12">
            <div data-aos="fade-right" class="ml-2 col-span-3 h-full w-full bg-yellow-300 p-5 bg-about bg-cover bg-center trapezoid"></div>
            <div data-aos="fade-down" class="bg-custom-primary h-full w-20"></div>
            <div  class="col-span-8 h-full space-y-16 w-full pl-5 pr-52 flex flex-col justify-center items-start leading-8">
                <p data-aos="fade-down" class="font-poppins text-custom-primary text-5xl font-bold">PUSDIKLAT PMI JATENG</p>
                <p data-aos="fade-up" class="font-poppins font-semibold text-2xl  text-black leading-loose">GEDUNG DIKLAT PMI PROVINSI JAWA TENGAH Terletak di kawasan perbukitan di Kota Semarang yang memiliki suasana nyaman dan jauh dari kebisingan kota, sehingga cocok digunakan untuk tempat rapat, pendidikan, pelatihan, seminar, dan lainnya. lingkungan Gedung Diklat yang Hijau dan rumah belajar memiliki beragam fasilitas yang tersedia serta pilihan menu hidangan yang ditawarkan berinovasi sehat dan lezat</p>
            </div>
        </div>
    </div>

{{-- Mitra kami --}}
    <div id="contact" class="bg-footer h-104 w-full mt-48 justify-center items-center flex flex-col">
        <div class="w-48 h-48 bg-admin rounded-full"></div>
        <p class="font-judson font-semibold text-4xl text-custom-third mt-4">Admin PMI</p>
        <p class="font-poppins font-semibold text-2xl px-104 text-center text-custom-third mt-4">Menginap di Pusdiklat sangatlah nyaman, tenang, dan banyak tukang cimol</p>
        <p class="font-poppins font-semibold text-2xl text-center mt-8 text-custom-third">PT. Menyala Polines</p>
    </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0  h-fit  items-center flex">
                        ...
                        <div class="ml-3 font-poppins text-custom-third justify-center items-start flex flex-col font-bold text-3xl">
                            <p>Palang</p>
                            <p>Merah</p>
                            <p>Indonesia</p>
                        </div>
                ...
                <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="#home"  class="text-white hover:text-custom-primary text-lg">Home</a></li>
                        <li class="mb-6"><a href="#rooms"  class=" text-white hover:text-custom-primary text-lg">Rooms</a></li>
                        <li class="mb-6"><a href="#meetingRooms"  class=" text-white hover:text-custom-primary text-lg">Meeting rooms</a></li>
                        <li class="mb-6"><a href="#services"  class=" text-white hover:text-custom-primary text-lg">Services</a></li>
                        <li class="mb-6"><a href="#about_us"  class=" text-white hover:text-custom-primary text-lg">About</a></li>
                ...
                <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="https://www.figma.com/"  class="text-white text-lg">Figma UI System</a></li>
                        <li class="mb-6"><a href="https://ionic.io/ionicons"  class=" text-white text-lg">IonIcon</a></li>
                        <li class="mb-6"><a href="https://tailwindcss.com/"  class=" text-white text-lg">Tailwind</a></li>
                        <li><a href="https://michalsnik.github.io/aos/"  class=" text-white text-lg">Components Library</a></li>
                    </ul>
                </div>
                <div class="lg:mx-auto text-left">
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    ...
                    <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="javascript:;"  class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-custom-primary">
