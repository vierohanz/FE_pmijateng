...
@section('content')
    ...
    <div class="overflow-x-hidden -mt-9">
        {{-- corousel --}}
        <div class="w-full bg-white">
                ...
                <div class="relative h-full w-full overflow-hidden rounded-b-badge shadow-lg">
                    ...
                    @foreach ($packages as $package)
                        <div class="block duration-700 ease-in-out" data-carousel-item>
                            <img src="{{ $package['thumbnail'] }}" alt="Image Package"
                    ...
                    <div class="absolute z-30 flex -translate-x-1/2 bottom-12 left-1/2 space-x-3 rtl:space-x-reverse">
                        @foreach ($packages as $index => $package)
                            <button type="button" class="w-3 h-3 rounded-full"
                                aria-current="{{ $index === 0 ? 'true' : 'false' }}" aria-label="Slide {{ $package['id'] }}"
                                data-carousel-slide-to="{{ $package['id'] }}"></button>
                        @endforeach
                    </div>
                </div>
                <!-- Slider controls -->
            ...
            <div class="h-80 xl:h-100 pl-6 w-full bg-white mt-8">
                <div id="bounceMeeting" class="carousel carousel-center bg-white rounded-box w-full space-x-7">
                    <div class="carousel-item w-108 h-64 xl:h-96">
                        <img src="{{ $package['thumbnail'] }}" alt="Image Package {{ $package['id'] }}"
                            class="rounded-box w-112 h-full bg-cover bg-center">
                    </div>
                </div>
            </div>
            ...
            <div class="h-44 px-6 xl:px-12 w-full  grid grid-cols-2">
                <div class="col-span-1 gap-2 flex-col flex items-start justify-start">
                    ...
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#E02424" viewBox="0 0 24 24"
                ...
                <div class="col-span-1 flex-col flex justify-start items-end gap-4">
                    ...
                    <div
                        class="w-40 px-2 xl:w-72 h-10 xl:h-20 rounded-full border-2 items-center justify-center flex border-red-500 ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon h-6 w-6 lg:h-16 lg:w-16 "
                            viewBox="0 0 512 512">
                            <rect x="32" y="80" width="448" height="256" rx="16" ry="16"
                                transform="rotate(180 256 208)" fill="none" stroke="#E02424" stroke-linejoin="round"
                                stroke-width="32" />
                            <path fill="none" stroke="#E02424" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="32" d="M64 384h384M96 432h320" />
                            <circle cx="256" cy="208" r="80" fill="none" stroke="#E02424"
                                stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                            <path
                                d="M480 160a80 80 0 01-80-80M32 160a80 80 0 0080-80M480 256a80 80 0 00-80 80M32 256a80 80 0 0180 80"
                                fill="none" stroke="#E02424" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="32" />
                        </svg>
                        <p class="ml-2 font-poppins text-red-500 text-sm lg:text-xl font-semibold">Rp
            ...
            <div class="w-full px-6 xl:px-12">
                <p class="font-poppins text-black text-xl leading-10 text-justify  font-medium">
                    {{ $package['description'] }}
                </p>
            </div>
            ...
            <div class="mt-20 w-full px-6 xl:px-12 flex-col flex ">
                ...
                <div class="grid grid-cols-3 mt-12">
                    <div class="col-span-1 flex gap-3 flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#E02424" class="ionicon w-16 h-16 xl:w-28 xl:h-28"
                            viewBox="0 0 512 512">
                            <path
                        ...
                        <p class="font-poppins text-xl text-custom-secondary font-semibold">
                            {{ $package['min_person_quantity'] }} Minimal Tamu </p>
                    </div>
                    <div class="col-span-1 gap-3 flex flex-col items-center justify-center">
                        ...
                        <p class="font-poppins text-xl text-custom-secondary font-semibold">35 Persegi </p>
                    </div>
                    <div class="col-span-1 gap-3 flex flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#E02424" class="ionicon w-16 h-16 xl:w-28 xl:h-28"
                            viewBox="0 0 512 512">
                        ...
                        <p class="font-poppins text-base xl:text-xl text-custom-secondary font-semibold">Sunrise
                        </p>
                    </div>
                </div>
                <div class="grid grid-cols-3 mt-28">
                    <div class="col-span-1 flex gap-3 flex-col items-center justify-center">
                        ...
                        <p class="font-poppins text-xl text-custom-secondary font-semibold">Nyaman</p>
                    </div>
                    <div class="col-span-1 gap-3 flex flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#E02424" class="ionicon w-16 h-16 xl:w-28 xl:h-28"
                            viewBox="0 0 512 512">
                    ...
                    <div class="col-span-1 gap-3 flex flex-col items-center justify-center">
                        ...
                        <p class="font-poppins text-xl text-custom-secondary font-semibold">Toko Roti</p>
                    </div>
                </div>
            </div>
            ...
            <div class="h-48 flex flex-col w-full mt-16 px-28">
                <div class="flex w-full bg-red-600 h-2"></div>
                <div class="w-full flex flex-col gap-y-3 md:gap-y-0 md:flex-row items-center justify-between mt-5">
                    <a href="{{ route('index') }}"
                        class="h-16 items-center justify-center text-xl hover:scale-110 duration-300 transition-all font-poppins font-semibold text-white flex w-36 lg:w-72 bg-red-600 rounded-2xl">
                        Back
                    </a>
