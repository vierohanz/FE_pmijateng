        ...
        <div class="w-full bg-white">
            ...
            <div class="mt-20 w-full px-6 xl:px-12 flex-col flex ">
                ...
                <div class="grid grid-cols-3 mt-12">
                    <div class="col-span-1 flex gap-3 flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#F05252" class="ionicon w-16 h-16 xl:w-28 xl:h-28"
                            viewBox="0 0 512 512">
                            <path
            ...
            <div class="h-48 flex flex-col w-full mt-16 px-28">
                ...
                <div class="w-full flex flex-col gap-y-3 md:gap-y-0 md:flex-row items-center justify-between mt-5">
                    <a href="{{ route('index') }}"
                        class="h-16 items-center justify-center text-xl hover:scale-110 duration-300 transition-all font-poppins font-semibold text-white flex w-36 lg:w-72 bg-red-500 rounded-2xl">
                        Back
                    </a>
