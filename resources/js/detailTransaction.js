document.addEventListener("DOMContentLoaded", function () {
    ...
    if (statusText === "success") {
        iconContainer.innerHTML = `
          ...
          textInformation.innerText = "Pesanan telah selesai. Kami tunggu pesanan berikutnya";
        ...
        iconContainer.innerHTML = `
          ...
          textInformation.innerText = "Pesanan tertunda. Segera lakukan pembayaran agar pesanan dapat diproses";
        ...
        iconContainer.innerHTML = `
          ...
          textInformation.innerText = "Pesanan gagal. Silahkan coba lagi atau hubungi kami jika terjadi kesalahan";
